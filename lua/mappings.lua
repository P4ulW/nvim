...
map('n', '<leader>dn', '<cmd> lua vim.diagnostic.goto_next() <CR>', {desc='goto next diagnostic'})
map('n', '<leader>i', '<cmd> lua vim.diagnostic.enable(not vim.diagnostic.is_enabled()) <CR>')
